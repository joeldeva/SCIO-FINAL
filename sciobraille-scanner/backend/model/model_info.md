...
- **Previous active model backup:** `best_previous_A.pt`
...
|-------|-------------|--------|------|------|
| A (DotNeuralNet transfer) | YOLOv8 + pretrained braille backbone | 92.88% | 50MB | best_previous_A.pt |
...
Runtime scanner falls back from enhanced-image inference to raw-image inference
when preprocessing produces zero detections. This keeps denoising for noisy
photos and avoids false negatives on clean high-contrast samples.
